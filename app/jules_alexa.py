...
def take_in(statement, memory, start=False):
    if start:
        name = raw_input("JULES: " + random.choice(
            hellos) + " I'm Jules and I'm here to learn about your life story. What's your name? \n> ")
